...
| java-jwt-based-security | - | ⚠️ Pending | May need upgrade |
| jwt-authentications/* | - | ⚠️ Pending | May need upgrade |
| component-based-security | - | ⚠️ Pending | May need upgrade |
| enable-method-security | - | ⚠️ Pending | May need upgrade |
