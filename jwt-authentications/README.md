...
d**Note:** Some of these projects are duplicates or very similar. See [../DUPLICATE_ANALYSIS.md](../DUPLICATE_ANALYSIS.md) for detailed analysis and recommendations.
